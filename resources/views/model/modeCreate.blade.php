     ...
     <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Add Model</h2>
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" data-parsley-validate="" method="POST" action="{{ route('model.store') }}"  novalidate="">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group row{{ $errors->has('parent') ? '           has-error' : '' }}">
                                            <label for="parent" class="col-3 col-lg-2 col-form-label text-right">Parent Model</label>

                                            <div class="col-9 col-lg-10">
                                                <select id="parent" class="form-control" name="parent"   autofocus>
                                        ...
                                        <div class="form-group row{{ $errors->has('details') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <textarea id="details" class="form-control" name="details" value="{{ old('details') }}" required></textarea>
                                        ...
                                        <div class="row pt-2 pt-sm-5 mt-1">
                                            <div class="col-sm-12 pl-0">
                                                <p class="text-right">
                                                    <button type="submit" class="btn btn-space btn-brand">Create Model</button>
                                                </p>
                                            </div>
                                        </div>
                                    </form>
