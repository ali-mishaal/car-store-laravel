   ...
   <div class="container-fluid  dashboard-content">
     ...
     <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Add Car</h2>
                ...
                <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Create Car</h5>
                                <div class="card-body">
                                    <form class="form-horizontal" data-parsley-validate="" method="POST" action="{{ route('car.store') }}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group row{{ $errors->has('produced') ? '           has-error' : '' }}">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input id="produced" type="date" class="form-control" name="produced" required>
                                        ...
                                        <div class="form-group row{{ $errors->has('mark') ? '           has-error' : '' }}">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input id="mark" type="text" class="form-control" name="mark" required>
